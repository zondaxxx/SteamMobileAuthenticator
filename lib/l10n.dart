...
class AppStrings {
  ...
  static const _en = <String, String>{
    ...
    'camera_denied': 'Camera access is denied, so QR codes cannot be scanned.',
    'camera_denied_hint': 'Allow the camera for this app in system settings, then reopen this screen.',
    'camera_error':
        'The camera is unavailable. Reopen this screen and try again.',
  ...
  static const _ru = <String, String>{
    ...
    'qr_secure': 'Безопасно',
    'torch': 'Фонарик',
    'scan_from_photo': 'Сканировать из фото',
    'camera_denied':
        'Доступ к камере запрещён, поэтому QR-код отсканировать нельзя.',
    'camera_denied_hint': 'Разреши камеру для этого приложения в настройках системы и открой экран заново.',
    'camera_error': 'Камера недоступна. Открой экран заново и повтори.',
